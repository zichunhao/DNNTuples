...
for DATASET in "${DATASETS[@]}"; do
    python3 create.py --dataset "/"${DATASET}/"Run3Summer22MiniAODv4-130X_mcRun3_2022_realistic_v5-v2/MINIAODSIM" \
    --eos-path "root://redirector.t2.ucsd.edu:1095//store/user/zichun/Hbb-tagger/samples/${DATASET}" \
    --job-tag ${DATASET} \
    --max-retries 10;
