...
deepntuplizer = cms.EDAnalyzer('DeepNtuplizer',
                                ...
                                genJetsWithMuMatch = cms.InputTag('ak8GenJetsWithNuMatch'),
                                genJetsWithMuSoftDropMatch = cms.InputTag('ak8GenJetsWithNuSoftDropMatch'),
                                genJetsNoMuMatch = cms.InputTag('ak8GenJetsNoNuMatch'),
                                genJetsNoMuSoftDropMatch = cms.InputTag('ak8GenJetsNoNuSoftDropMatch'),
